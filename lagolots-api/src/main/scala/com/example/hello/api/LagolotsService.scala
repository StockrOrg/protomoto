...
object LagolotsService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagolots service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagolotsService.
  */
trait LagolotsService extends Service {
  ...
  override final def descriptor = {
    ...
    named("lagolots")
      ...
      .withTopics(
        topic(LagolotsService.TOPIC_NAME, greetingsTopic)
